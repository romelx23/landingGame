    ...
    <>
      <div className="message__content">
        <div className="avatar__content">
          <img
            src="https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/e8/e80d676d0f634f449c4ca0e5669e893bc1a02fa5_full.jpg"
            alt="avatar"
          />
          <svg
        ...
        <div className="message__dialog">
          <div className="message__dialog__head">
            <h4>Squish[32]</h4>
            <h5>12:35</h5>
          </div>
          <h4>
